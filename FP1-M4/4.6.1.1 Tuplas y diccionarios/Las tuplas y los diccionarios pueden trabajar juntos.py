...
for name in sorted(school_class.keys()):
    ...
    # Ingresa el nombre del estudiante: Camilo
    ...
    # Ingresa el nombre del estudiante: Camilo
    # Ingresa la calificación del estudiante (0-10): 4
    # Ingresa el nombre del estudiante: Juan 
    # Ingresa la calificación del estudiante (0-10): 6
    # Ingresa el nombre del estudiante: Loco
    # Ingresa la calificación del estudiante (0-10): 7
